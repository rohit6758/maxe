...
const targetStr = `    setFollowingMap(map);
    setIsLoadingMembers(false);
  };`;

const replacementStr = `    setFollowingMap(map);
...
const renderTarget = `            <div className="overflow-y-auto space-y-4">
              {/* Current Members */}`;

const renderReplacement = `            <div className="overflow-y-auto space-y-4">
              {/* Pending Requests */}
