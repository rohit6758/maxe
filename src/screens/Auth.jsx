...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 animate-fade-in" style={{background:'var(--theme-bg)'}}>
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-aberration" style={{color:'var(--theme-header)'}}>Maxe</h1>
          <p className="text-sm mt-1" style={{color:'var(--theme-primary)'}}>Your academic study hub</p>
        </div>

        <div className="card p-6 space-y-5">
          <div className="text-center space-y-2 mb-6">
            <h2 className="text-xl font-bold" style={{color:'var(--theme-header)'}}>Welcome to Maxe</h2>
            <p className="text-sm" style={{color:'var(--theme-primary)'}}>Sign in or Create an Account to continue.</p>
          </div>
          ...
          <button type="button" onClick={handleGoogle} disabled={loading}
            ...
            style={{background:'#FFFFFF', color:'var(--theme-header)', border:'2px solid color-mix(in srgb, var(--theme-primary) 15%, transparent)', boxShadow:'0 2px 8px rgba(0,0,0,0.02)'}}>
          ...
          <p className="text-center text-xs mt-4" style={{color:'var(--theme-primary)'}}>
