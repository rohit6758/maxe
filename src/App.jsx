...
const ProtectedRoute = ({ children }) => {
  ...
  if (loading) return (
    <div className="h-screen w-full flex flex-col items-center justify-center gap-4 animate-pulse" style={{background: 'var(--color-background)'}}>
      <div className="w-16 h-16 rounded-full border-4 animate-spin" style={{borderColor: 'rgba(79, 93, 83,0.2)', borderTopColor: 'var(--color-primary)'}} />
      <p className="font-bold tracking-widest text-sm uppercase" style={{color: 'var(--color-primary)'}}>Loading Maxe</p>
    </div>
  );
