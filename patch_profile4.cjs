...
const regex = /  return \(\s*<div className="space-y-4 pb-24 md:pb-8">[\s\S]*?\)\s*:\s*\(\s*<div className="card p-5 space-y-5">/m;

if (regex.test(c)) {
  c = c.replace(regex, NEW_RETURN_START + '\n        <div className="card p-5 space-y-5">');
  ...
  console.log('Successfully patched Profile.jsx via regex');
} else {
