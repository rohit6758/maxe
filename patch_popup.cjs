...
// 2. Add effects rendering logic inside the component
...
const newRenderStart = `  // Get the effective theme and profile effects for this user
  // If it's us, use our actual settings. If it's someone else who is premium, fake it for the demo
...
if (c.includes('  return (')) {
  ...
  if (startIdx > -1 && endIdx > -1) {
    c = c.substring(0, startIdx) + newRenderStart + c.substring(endIdx + endStr.length);
